 ...
 * }
*/
function makePersonObject(idNumber, firstName, userMail) {
  /* code here */
  return {
    id: idNumber,
    name: firstName,
...
console.log(makePersonObject(10, "Doren", "dorenfortune@fortune.com"));
...
function makeSmartPerson(Kody) {
   let pupper = {
     ...
     speak: function(){
       return `Hello, my name is ${pupper.name}`;
     }
   }
   return pupper;
  };
  console.log(makeSmartPerson("Kya"));
